...
const services = [
  {
    title: "MOBILE TUNING & REMAPPING",
    desc: "Expert Mobile Tuning Specialist bringing performance and economy remaps directly to you. We provide professional engine optimization tailored to your vehicle's needs.",
    image: "/mobile-tuning.avif",
    path: "/services/mobile-tuning",
  },
  {
    title: "SERVICING & REPAIRS",
    desc: "With 25 years of experience, we provide high-quality automotive servicing and repairs. From diagnostics to mechanical fixes, we ensure your vehicle runs at its best.",
    image: "/servicing.avif",
    path: "/services/servicing-repairs",
  },
  {
    title: "DPF/EGR SOLUTIONS",
    desc: "Specialized software and mechanical solutions for DPF and EGR systems. We help reduce emissions and improve engine reliability using industry-leading techniques.",
    image: "/solutions.avif",
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {services.map((service, index) => (
             ...
             hover:scale-105 active:scale-105 bg-black/50 hover:shadow-primary hover:border-primary/80 dark:bg-black/30 transition-all duration-300"
                data-aos="fade-up"
              ...
              >
                ...
                <div className="max-w-sm mx-auto ">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-50   "
                    onError={(e) => {
