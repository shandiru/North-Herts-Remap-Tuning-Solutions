...
const testimonials = [
{
    text: "Dan diagnosed a faulty water pump and came back to fit it, so my car now runs well. Really pleased with the results. He was very knowledgeable, professional and helped to identify the right part too. Recommended.",
    name: "Tom Salmond - North Herts Customer"
  },
